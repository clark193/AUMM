...
export function AdminSettingsPage() {
  ...
  return <div className="settings-layout"><div className="dash-welcome"><div><span className="access-badge">Conta administrativa</span><h2 style={{ marginTop: 12 }}>Configurações do painel</h2><p>Gerencie seu perfil, notificações e segurança. Os dados institucionais ficam disponíveis somente para o nível 1.</p></div><Settings size={40} /></div>
