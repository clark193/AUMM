...
export function SiteFooter() {
  ...
  return <footer className="footer">
    <div className="container footer-grid">
      ...
      <div><h3>Institucional</h3><Link href="/quem-somos">Quem somos</Link><Link href="/realizacoes">O que já fizemos</Link><Link href="/centrodeapoioaomotoboy">Centro de Apoio ao Motoboy</Link><Link href="/diretoria">Diretoria</Link><Link href="/estatuto">Estatuto Social</Link><Link href="/documentos">Documentos</Link></div>
